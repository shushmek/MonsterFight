...
public:
	...
	Slider(Vector2f const& position, string const& texturePath, Texture const& texture, string const& buttonText, string const& fontPath, string const& clickSoundPath = "", Color const& textCol = Color::Black, int const& size = 24);
