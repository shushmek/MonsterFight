...
public:
	...
	Armor(const string& name, const Rarity& rarity, const int& armor, const int& min, const int& max, const int& move, const int& combo, const int& crit, const float& critMode, Texture const& texture, IntRect const& rect, int frameCount, int Ycount, int frameTime = 0, float animTime = 0);
	int getArmor();
	string getName();
	int getRarity();
	int getMinBet();
